...
class UpdateOrderStatusUseCase @Inject constructor(private val firebaseFireStoreRepo: FirebaseFireStoreRepo) {

    operator fun invoke(documentId : String,param : String) : Flow<Resource<Boolean>> {
        return callbackFlow {
            trySend(Resource.Loading())
            firebaseFireStoreRepo.updateOrderStatus(documentId, param).addOnSuccessListener {
